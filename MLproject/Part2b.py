...
class MLPart2a:
    def __init__(self, __trainingDataFile, __testDataFile, __k, __distance_weighted = True,  __distance_measurements=1):
        self.weight = 10000
        ...
        self.__distance_measurements = __distance_measurements
    ...
    def predictCategories_weighted(self):
        prediction = np.array([])
    ...
    def predictCategories_basic(self):
